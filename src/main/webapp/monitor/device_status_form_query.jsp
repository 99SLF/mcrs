...
<!--
  - Author(s): 李伟杰
  - Date: 2023-02-09 12:49:25
  - Description:
-->
<head>
    <title>终端状态高级查询</title>
    <meta charset="utf-8">
...
<body>
<div class="layui-form" lay-filter="layuiadmin-device_status-form" id="layuiadmin-device_status-form">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">CUP使用率：</label>
        <div class="layui-input-block" >
            <input type="text" class="layui-input" name="cpuRate" autocomplete="off" />
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">内存使用率：</label>
        <div class="layui-input-block" >
            <input type="text" class="layui-input" name="storageRate" autocomplete="off" />
        </div>
    </div>

    <div class="layui-form-item">
        <label class="layui-form-label">误读率：</label>
        <div class="layui-input-block" >
            <input type="text" class="layui-input" name="errorRate" autocomplete="off" />
        </div>
    </div>
    <div class="layui-form-item layui-hide">
        <div class="layui-inline layui-search" style="padding-left:15px">
            <button id="LAY-app-device_status-search-advanced" class="layui-btn layuiadmin-btn-list" lay-submit lay-filter="LAY-app-device_status-search-advanced">
...
<script type="text/javascript">
    ...
    $(".layui-input").on("keydown", function(event) {
        if (event.keyCode == 13) {
            var submit = $("#LAY-app-device_status-search-advanced");
            submit.click();
            return false;
        }
    });
    ...
    //监听提交
    form.on("submit(LAY-app-device_status-search-advanced)", function(data) {
