		...
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline" >
					<input type="text" name="warningTitle" value="" placeholder="请输入预警标题" autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline" >
					<input type="text" name="warningType" value="" placeholder="请输入预警类型" autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline" >
					<input type="text" name="warningLevel" value="" placeholder="请输入预警等级" autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline" >
					<input type="text" name="occurTime" value="" placeholder="请选择发生时间" id="test0" autocomplete="off" class="layui-input">
				</div>
			</div>
