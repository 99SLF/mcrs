            ...
            <div class="layui-card">
                <div class="layui-card-body" id="layui-card-body02">
                    <div class="layui-show">
                        <iframe  width=100% height= 100% scrolling="yes" frameborder="0" ></iframe>
                    </div>
                </div>
            </div>
        </div>
...
function authConfig(data) {
        ...
        var url = "<%=request.getContextPath() %>/basic/aboutEmployee/rescourse/resource_tree.jsp?roleId=" + roleId;
