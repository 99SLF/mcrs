...
<div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list"
    ...
    <div class="layui-form-item layui-row layui-col-space10">
        <div class="layui-col-sm6">
            ...
            <div class="layui-input-block">
                <input id="isEnable" type="text" name="isEnable" lay-verify="required|isEnable"
                       placeholder="" autocomplete="off" class="layui-input" readonly>
            </div>
        </div>
        <div class="layui-col-sm6">
    ...
    <div class="layui-form-item layui-row layui-col-space10">
        ...
        <div class="layui-col-sm6">
            ...
            <div class="layui-input-block">
                <input id="factoryCode" type="text" name="factoryCode"
                       lay-verify="required|factoryCode"
                       placeholder="" autocomplete="off" class="layui-input" readonly>
            </div>
        </div>
    ...
    <div class="layui-form-item layui-row layui-col-space10">
        <div class="layui-col-sm6">
            ...
            <div class="layui-input-block">
                <input id="processCode" type="text" name="processCode" lay-verify="required|processCode"
                       placeholder="" autocomplete="off" class="layui-input" readonly>
            </div>
        </div>
    ...
    <div class="layui-form-item layui-row layui-col-space10">
        <div class="layui-col-sm12">
            ...
            <textarea cols="50" rows="10" style="width:100%;height:100px" name="processRemarks" id="processRemarks" autocomplete="off"
                      class="layui-input" lay-verify="processRemarks" readonly></textarea>
            </div>
        </div>
    </div>
