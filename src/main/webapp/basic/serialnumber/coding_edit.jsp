...
<div class="layui-fluid">
	<div class="layui-form" lay-filter="coding-edit" id="coding-edit" style="padding: 20px 30px 0 0;">
		<input type="text" class="layui-input layui-hide" id="id" name="id">
		<div class="layui-row layui-col-space10 layui-form-item" >
			<div class="layui-col-sm6">
				<label class="layui-form-label" ><span style="color:red">*</span>规则编码：</label>
				<div class="layui-input-block">
					<input type="text"  class="layui-input" name="functionNum" lay-verify="required|chinese|length32" autocomplete="off" placeholder="英文、数字、符号，不能超过32个字符" disabled="disabled">
				</div>
			</div>
			<div class="layui-col-sm6">
...
<script type="text/javascript">
	...
	function SetData(obj) {
		...
		form.val('coding-edit',{
		    "id":serial.id,
			"functionNum":serial.functionNum,
			"functionName":serial.functionName,
			"titleRule":serial.titleRule,
			"numberRule":serial.numberRule,
			"digit":serial.digit,
			"startvalue":serial.startvalue,
			"numBasis":serial.numBasis,
			"note":serial.note,
		});
	}
    ...
    form.on('submit(save_data)', function(data) {
		if(submit == false){
			...
			$.ajax({
				url : "<%=request.getContextPath() %>/serialnumber/update",
				type : 'PUT',
				data : submitData,
				cache : false,
