	...
	<div class="layui-card">
		<div class="layui-form layui-card-header layuiadmin-card-header-auto ">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label">预警分类：</label>
					<div class="layui-input-inline">
						<input type="text" name="alarmCategory" placeholder="" autocomplete="off"
							   class="layui-input">
					</div>
					<label class="layui-form-label">预警类型：</label>
					<div class="layui-input-inline">
						<input type="text" name="alarmType" placeholder="" autocomplete="off"
							   class="layui-input">
					</div>
