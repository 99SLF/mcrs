    ...
    <div class="layui-form layui-card-header layuiadmin-card-header-auto">
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" >
                    <input type="text" name="axisName" value="" placeholder="请输入轴名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" >
                    <input type="text" name="antennaLoc" value="" placeholder="请输入来料SFC编码" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                <%--                <label class="layui-form-label">设备资源号：</label>--%>
                <div class="layui-input-inline" >
                    <input type="text" name="inSFCId" value="" placeholder="请输入生产SFC编码" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" >
                    <input type="text" name="prodSFCId" value="" placeholder="请输入载具码" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" >
                    <input type="text" name="startProdTime" value="" placeholder="请选择开始时间" id="test0" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" >
                    <input type="text" name="endProdTime" value="" placeholder="请选择结束时间" id="test1" autocomplete="off" class="layui-input">
                </div>
            </div>
