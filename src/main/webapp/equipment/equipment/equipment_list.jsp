	...
	<div class="layui-card">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="name" placeholder="请输入设备资源号" autocomplete="off" class="layui-input">
					</div>
				...
				<div class="layui-inline layui-search">
					<button class="layui-btn layuiadmin-btn-list" lay-submit lay-filter="LAY-app-equipmentlist-search" id="LAY-app-equipmentlist-search">
		...
		<div class="layui-card-body">
			<div class="layui-toolbar" id="toolbar" hidden="true">
				<button class="layui-btn layuiadmin-btn-list layui-btn-sm" lay-event="add"><i class="layui-icon layui-icon-add-circle-fine"></i>新建</button>
				<button class="layui-btn layuiadmin-btn-list layui-btn-danger layui-btn-sm" lay-event="batchdel"><i class="layui-icon layui-icon-delete"></i>导入</button>
			</div>
	...
	table.on("tool(LAY-app-equipment-list)", function(e) {
		...
		if (e.event == "edit") {
			...
			layer.confirm("确定删除该设备？", {
				...
				$.ajax({
					url: "com.zimax.max.newcomponent.delete.biz.ext",
					type: "POST",
					data: JSON.stringify({
						equipment: data
					}),
