...
<%--                &lt;%&ndash;                <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="edit"><i&ndash;%&gt;--%>
<%--                &lt;%&ndash;                        class="layui-icon layui-icon-edit"></i>编辑</a>&ndash;%&gt;--%>
...
<%--    &lt;%&ndash;var active = {&ndash;%&gt;--%>
<%--    &lt;%&ndash;    //设备新建&ndash;%&gt;--%>
<%--    &lt;%&ndash;    add: function () {&ndash;%&gt;--%>
<%--    &lt;%&ndash;        top.layer.open({&ndash;%&gt;--%>
<%--    &lt;%&ndash;            type: 2,&ndash;%&gt;--%>
<%--    &lt;%&ndash;            title: "设备新建",&ndash;%&gt;--%>
<%--    &lt;%&ndash;            content: "<%= request.getContextPath() %>/deviceUpgrade/deviceUpgrade/deviceUpgrade_add.jsp",&ndash;%&gt;--%>
<%--    &lt;%&ndash;            area: ["1000px", "560px"],&ndash;%&gt;--%>
<%--    &lt;%&ndash;            resize: false,&ndash;%&gt;--%>
<%--    &lt;%&ndash;            btn: ["确定", "取消"],&ndash;%&gt;--%>
<%--    &lt;%&ndash;            success: function (layero, index) {&ndash;%&gt;--%>
<%--    &lt;%&ndash;                var dataJson = {&ndash;%&gt;--%>
<%--    &lt;%&ndash;                    win: window,&ndash;%&gt;--%>
<%--    &lt;%&ndash;                };&ndash;%&gt;--%>
<%--    &lt;%&ndash;                layero.find("iframe")[0].contentWindow.SetData(dataJson);&ndash;%&gt;--%>
<%--    &lt;%&ndash;            },&ndash;%&gt;--%>
<%--    &lt;%&ndash;            yes: function (index, layero) {&ndash;%&gt;--%>
<%--    &lt;%&ndash;                var submit = layero.find("iframe").contents().find("#layuiadmin-app-form-submit");&ndash;%&gt;--%>
<%--    &lt;%&ndash;                submit.click();&ndash;%&gt;--%>
<%--    &lt;%&ndash;            }&ndash;%&gt;--%>
<%--    &lt;%&ndash;        });&ndash;%&gt;--%>
<%--    &lt;%&ndash;    },&ndash;%&gt;--%>
<%--    &lt;%&ndash;};&ndash;%&gt;--%>
