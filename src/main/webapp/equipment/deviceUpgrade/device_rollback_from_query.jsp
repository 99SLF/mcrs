...
<!--
  - Author(s): 李伟杰
  - Date: 2023-2-6 9:27:25
  - Description:
-->
<head>
    <title>回退记录高级查询</title>
    <meta charset="utf-8">
...
<body>
<div class="layui-form" lay-filter="layuiadmin-deviceRollback-form" id="layuiadmin-deviceRollback-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input id="versionRollbackTime" type="text" class="layui-input" name="versionRollbackTime" autocomplete="off" />
        </div>
    </div>
    <div class="layui-form-item layui-hide">
        <div class="layui-inline layui-search" style="padding-left:15px">
            <button id="LAY-app-deviceRollback-list-search-advanced" class="layui-btn layuiadmin-btn-list" lay-submit lay-filter="LAY-app-deviceRollback-list-search-advanced">
...
<script type="text/javascript">
    ...
    $(".layui-input").on("keydown", function(event) {
        if (event.keyCode == 13) {
            var submit = $("#LAY-app-deviceRollback-list-search-advanced");
            submit.click();
            return false;
        }
    });
    ...
    function SetData(data) {
        ...
        form.val("layuiadmin-deviceRollback-form", {
            ...
            versionRollbackTime: formData.versionRollbackTime ? util.toDateString(formData.versionRollbackTime, "yyyy-MM-dd") : ""
        });
    }
    ...
    //监听提交
    form.on("submit(LAY-app-deviceRollback-list-search-advanced)", function(data) {
