...
<div class="layui-card">
    <script type="text/html" id="toolbar">
        <div class="layui-form layuiadmin-card-header-auto" lay-filter="layuiadmin-deviceUpgrade-form" id="layuiadmin-deviceUpgrade-form">
            <div class="layui-form-item">
                ...
                <div class="layui-inline layui-hide">
                    <button id="LAY-app-deviceUpgrade-list-search" class="layui-btn layuiadmin-btn-list" lay-submit lay-filter="LAY-app-deviceUpgrade-list-search">
...
<script type="text/javascript">
    ...
    //功能名，查询过滤字段和列筛选
    var funName = "deviceUpgrade_list";
    ...
    //监听搜索
    form.on("submit(LAY-app-deviceUpgrade-list-search)", function (data) {
        ...
        form.val("layuiadmin-deviceUpgrade-form", formData);
    ...
    function formReder() {
        ...
        $(".layui-input").on("keydown", function (event) {
            if (event.keyCode == 13) {
                ...
                var submit = $("#LAY-app-deviceUpgrade-list-search");
                submit.click();
                return false;
            }
        });
    ...
    var active = {
        ...
        //高级搜索
        query: function () {
            var url = "<%=request.getContextPath() %>/equipment/deviceUpgrade/device_upgrade_from_query.jsp";
            admin.popupRight({
                type: 2,
                content: [url, "yes"],
                btn: ["查询", "重置", "取消"],
                ...
                yes: function (index, layero) {
                    var submit = layero.find("iframe").contents().find("#LAY-app-deviceUpgrade-list-search-advanced");
                    submit.click();
