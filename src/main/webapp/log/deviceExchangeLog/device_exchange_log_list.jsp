		...
		<div class="layui-form layui-card-header layuiadmin-card-header-auto">
			<div class="layui-form-item layui-col-space12">
				<div class="layui-input-inline">
					<input type="text" name="equipmentId" placeholder="设备资源号" autocomplete="off"
						   class="layui-input">
				</div>
				<div class="layui-input-inline">
					<input type="text" name="equipmentContinuePort" placeholder="请输入端口号" autocomplete="off"
						   class="layui-input">
				</div>
				<div class="layui-input-inline">
					<input type="text" name="processName" placeholder="请输入使用工序" autocomplete="off"
						   class="layui-input">
				</div>
				<div class="layui-input-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="exchangeTime" id="exchangeTime" placeholder="请输入交互时间" autocomplete="off"
						   class="layui-input">
				</div>
				...
				<div class="layui-inline layui-search">
					<button class="layui-btn layuiadmin-btn-list" lay-submit
							...
							id="LAY-app-deviceExchangeLoglist-search">查询
