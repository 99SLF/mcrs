...
<div class="layui-card">
    <script type="text/html" id="toolbar">
        <div class="layui-form layuiadmin-card-header-auto" lay-filter="layuiadmin-plcLog-form" id="layuiadmin-plcLog-form">
            <div class="layui-form-item">
                ...
                <div class="layui-inline layui-hide">
                    <button id="LAY-app-plcLog-search" class="layui-btn layuiadmin-btn-list" lay-submit lay-filter="LAY-app-plcLog-search">
...
<script type="text/javascript">
    ...
    // 监听搜索
    form.on("submit(LAY-app-plcLog-search)", function(data) {
        ...
        form.val("layuiadmin-plcLog-form", formData);
    ...
    var active = {
        search: function() {
            var submit = $("#LAY-app-plcLog-search");
            submit.click();
            return false;
        },
        query: function() {
            var url = "<%=request.getContextPath() %>/log/plcLog/plcLog_form_query.jsp";
            admin.popupRight({
                type: 2,
                content: [url, "yes"],
                btn: ["查询", "重置", "取消"],
                ...
                yes: function(index, layero) {
                    var submit = layero.find("iframe").contents().find("#LAY-app-plcLog-search-advanced");
                    submit.click();
    ...
    table.render({
        ...
        url: "<%= request.getContextPath() %>/log/plcLog/query",
        method: "GET",
        height: "full-" + getFullSize(),
        page: true,
        limit: 10,
