...
<body>
<div class="layui-form" lay-filter="layuiadmin-mesLog-form" id="layuiadmin-mesLog-form">
    ...
    <div class="layui-form-item layui-hide">
        <div class="layui-inline layui-search" style="padding-left:15px">
            <button id="LAY-app-mesLog-search-advanced" class="layui-btn layuiadmin-btn-list" lay-submit
                    lay-filter="LAY-app-mesLog-search-advanced">
...
<script type="text/javascript">
    ...
    $(".layui-input").on("keydown", function (event) {
        if (event.keyCode == 13) {
            var submit = $("#LAY-app-mesLog-search-advanced");
            submit.click();
            return false;
        }
    });
    ...
    //监听提交
    form.on("submit(LAY-app-mesLog-search-advanced)", function (data) {
