...
public interface EquipMapper {
    ...
    int count(@Param("equipTypeCode") String equipTypeCode, @Param("equipTypeName") String equipTypeName ,@Param("creator") String creator, @Param("createTime") String createTime);
