package com.zimax.cap.utility.impl;

import com.zimax.cap.utility.impl.DecoderException;
import com.zimax.cap.utility.impl.EncoderException;

/**
 * @author 苏尚文
 * @date 2022/12/9 18:20
 */
public class Base64 {
    ...
    public Object decode(Object pObject) throws DecoderException {
        ...
        Object result = decode((byte[]) pObject);

        return result;
    }

    public byte[] decode(byte[] pArray) {
        byte[] result = decodeBase64(pArray);
        return result;
    }
    ...
    public Object encode(Object pObject) throws EncoderException {
        ...
        Object result = encode((byte[]) pObject);
